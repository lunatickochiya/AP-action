...
function patch_openwrt_core_pre() {
	...
	sed -i 's/^	b43-fwsquash.py "$(CONFIG_B43_FW_SQUASH_PHYTYPES)" "$(CONFIG_B43_FW_SQUASH_COREREVS)"/	$(TOPDIR)\/tools\/b43-tools\/files\/b43-fwsquash.py "$(CONFIG_B43_FW_SQUASH_PHYTYPES)" "$(CONFIG_B43_FW_SQUASH_COREREVS)"/' ./package/firmware/b43legacy-firmware/Makefile
	sed -i 's/^	b43-fwsquash.py/	$(TOPDIR)\/tools\/b43-tools\/files\/b43-fwsquash.py/' ./package/firmware/b43legacy-firmware/Makefile
# for 2410
